...
class CommentRecordClick extends StatefulWidget {
  final FocusNode focusNode;
  final CommentCubit cubit;
  final String postId;

  const CommentRecordClick(
      {Key? key,
  ...
  @override
  State<CommentRecordClick> createState() => _CommentRecordClickState();
}

class _CommentRecordClickState extends State<CommentRecordClick> with WidgetsBindingObserver {
          ...
          : () async {
              if (stopWatchTimer.rawTime.value > 1600) {
                ...
                !widget.cubit.isReplyComment
                    ? await widget.cubit.createNewComment(
                    ...
                    : await widget.cubit.createReplyComment(
                        postId: widget.postId,
                        commentId: widget.cubit.commentClickId,
                        profilePhoto: meInfo[0]['profilePhotoUrl'].toString(),
                        name: meInfo[0]['name'].toString(),
                        email: meInfo[0]['email'].toString(),
                        uid: meInfo[0]['uid'].toString(),
